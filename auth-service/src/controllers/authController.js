...
exports.forgotPassword = async (req, res) => {
    try {
        ...
        try {
            ...
            // Prepare response based on whether we used a test email or real email
            let responseMessage = 'Password reset instructions have been sent to your email';
            let additionalData = {};

            // If using Ethereal test email, include the preview URL
            if (emailInfo.isTestEmail && emailInfo.messageUrl) {
                responseMessage = 'TEST MODE: Password reset email generated but not actually sent';
                additionalData.previewUrl = emailInfo.messageUrl;
                additionalData.note = 'This is a test email using Ethereal. To receive real emails, configure a valid Gmail App Password.';
